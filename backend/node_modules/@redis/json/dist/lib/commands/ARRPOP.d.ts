...
declare const _default: {
    ...
    readonly transformReply: (this: void, reply: NullReply | BlobStringReply | ArrayReply<NullReply | BlobStringReply>) => string | number | boolean | NullReply | Date | {
        [key: string]: import("@redis/json/dist/lib/commands/helpers").RedisJSON;
        [key: number]: import("@redis/json/dist/lib/commands/helpers").RedisJSON;
    } | (NullReply | import("@redis/json/dist/lib/commands/helpers").RedisJSON)[] | null;
};
