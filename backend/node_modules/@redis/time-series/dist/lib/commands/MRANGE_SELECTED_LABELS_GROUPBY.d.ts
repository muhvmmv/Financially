...
import { SampleRawReply, Timestamp } from '@redis/time-series/dist/lib/commands/helpers';
import { TsRangeOptions } from '@redis/time-series/dist/lib/commands/RANGE';
import { TsMRangeGroupBy, TsMRangeGroupByRawMetadataReply3 } from '@redis/time-series/dist/lib/commands/MRANGE_GROUPBY';
...
declare const _default: {
    ...
    readonly transformReply: {
        readonly 2: (this: void, reply: import("@redis/time-series/dist/lib/commands/MRANGE_SELECTED_LABELS").TsMRangeSelectedLabelsRawReply2, _?: any, typeMapping?: import("@redis/client/dist/lib/RESP/types").TypeMapping | undefined) => MapReply<BlobStringReply<string>, {
