...
import { RedisArgument, RespVersions, TuplesToMapReply, BlobStringReply, NumberReply, ArrayReply } from '@redis/client/dist/lib/RESP/types';
...
declare const _default: {
    ...
    readonly transformReply: {
        readonly 2: (reply: [BlobStringReply<"server">, BlobStringReply<string>, BlobStringReply<"version">, BlobStringReply<string>, BlobStringReply<"proto">, NumberReply<RespVersions>, BlobStringReply<"id">, NumberReply<number>, BlobStringReply<"mode">, BlobStringReply<string>, BlobStringReply<"role">, BlobStringReply<string>, BlobStringReply<"modules">, import("@redis/client/dist/lib/RESP/types").RespType<42, BlobStringReply<string>[], never, BlobStringReply<string>[]>]) => {
            ...
            modules: import("@redis/client/dist/lib/RESP/types").RespType<42, BlobStringReply<string>[], never, BlobStringReply<string>[]>;
        };
