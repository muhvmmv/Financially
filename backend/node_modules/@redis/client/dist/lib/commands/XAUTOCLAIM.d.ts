...
import { RedisArgument, TuplesReply, BlobStringReply, ArrayReply, NullReply, TypeMapping } from '@redis/client/dist/lib/RESP/types';
...
declare const _default: {
    ...
    readonly transformReply: (this: void, reply: [nextId: BlobStringReply<string>, messages: ArrayReply<NullReply | StreamMessageRawReply>, deletedMessages: ArrayReply<BlobStringReply<string>>], preserve?: any, typeMapping?: TypeMapping) => {
        ...
        messages: (NullReply | import("@redis/client/dist/lib/commands/generic-transformers").StreamMessageReply)[];
