...
import { RedisArgument, TuplesToMapReply, BlobStringReply, NumberReply, NullReply, TuplesReply, ArrayReply } from '@redis/client/dist/lib/RESP/types';
/**
    ...
    readonly transformReply: {
        readonly 2: (this: void, reply: any) => {
            ...
            "first-entry": NullReply | {
                ...
                message: import("@redis/client/dist/lib/RESP/types").MapReply<BlobStringReply<string>, BlobStringReply<string>>;
            };
