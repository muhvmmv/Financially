...
import { RedisArgument, ArrayReply, UnwrapReply, TypeMapping } from '@redis/client/dist/lib/RESP/types';
import { StreamMessageRawReply } from '@redis/client/dist/lib/commands/generic-transformers';
/**
...
declare const _default: {
     ...
     */
    readonly transformReply: (this: void, reply: UnwrapReply<ArrayReply<StreamMessageRawReply>>, preserve?: any, typeMapping?: TypeMapping) => import("@redis/client/dist/lib/commands/generic-transformers").StreamMessageReply[];
};
