...
import { RedisArgument, ArrayReply, NullReply, UnwrapReply, TypeMapping } from '@redis/client/dist/lib/RESP/types';
import { RedisVariadicArgument, StreamMessageRawReply } from '@redis/client/dist/lib/commands/generic-transformers';
/**
...
declare const _default: {
     ...
     */
    readonly transformReply: (this: void, reply: UnwrapReply<ArrayReply<StreamMessageRawReply | NullReply>>, preserve?: any, typeMapping?: TypeMapping) => (NullReply | import("@redis/client/dist/lib/commands/generic-transformers").StreamMessageReply)[];
};
