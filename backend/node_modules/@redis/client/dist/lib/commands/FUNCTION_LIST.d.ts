...
import { RedisArgument, TuplesToMapReply, BlobStringReply, ArrayReply, NullReply, SetReply, UnwrapReply, Resp2Reply } from '@redis/client/dist/lib/RESP/types';
    ...
    readonly transformReply: {
        readonly 2: (reply: UnwrapReply<Resp2Reply<FunctionListReply>>) => {
            ...
            functions: {
                ...
                flags: import("@redis/client/dist/lib/RESP/types").RespType<126, BlobStringReply<string>[], never, BlobStringReply<string>[]>;
            }[];
        }[];
