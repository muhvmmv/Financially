...
import { Command, CommandArguments, CommanderConfig, CommandSignature, /*CommandPolicies, CommandWithPoliciesSignature,*/ TypeMapping, RedisArgument, RedisFunctions, RedisModules, RedisScripts, ReplyUnion, RespVersions } from '@redis/client/dist/lib/RESP/types';
import COMMANDS from '@redis/client/dist/lib/commands';
import { EventEmitter } from 'node:events';
import RedisClusterSlots, { NodeAddressMap, ShardNode } from '@redis/client/dist/lib/cluster/cluster-slots';
...
import { RedisTcpSocketOptions } from '@redis/client/dist/lib/client/socket';
import { ClientSideCacheConfig, PooledClientSideCacheProvider } from '@redis/client/dist/lib/client/cache';
...
export default class RedisCluster<M extends RedisModules, F extends RedisFunctions, S extends RedisScripts, RESP extends RespVersions, TYPE_MAPPING extends TypeMapping> extends EventEmitter {
     ...
     */
    get slots(): import("@redis/client/dist/lib/cluster/cluster-slots").Shard<M, F, S, RESP, TYPE_MAPPING>[];
     ...
     */
    get masters(): import("@redis/client/dist/lib/cluster/cluster-slots").MasterNode<M, F, S, RESP, TYPE_MAPPING>[];
    /**
     ...
     * Use with {@link RedisCluster.prototype.nodeClient} to get the client for a specific node (master or replica).
     */
    get nodeByAddress(): Map<string, import("@redis/client/dist/lib/cluster/cluster-slots").MasterNode<M, F, S, RESP, TYPE_MAPPING> | ShardNode<M, F, S, RESP, TYPE_MAPPING>>;
    /**
     * The current pub/sub node.
     */
    get pubSubNode(): (Omit<import("@redis/client/dist/lib/cluster/cluster-slots").Node<M, F, S, RESP, TYPE_MAPPING>, "client"> & Required<Pick<import("@redis/client/dist/lib/cluster/cluster-slots").Node<M, F, S, RESP, TYPE_MAPPING>, "client">>) | undefined;
    get isOpen(): boolean;
     ...
     * TODO
     */
    getMasters(): import("@redis/client/dist/lib/cluster/cluster-slots").MasterNode<M, F, S, RESP, TYPE_MAPPING>[];
    /**
     * @deprecated use `.slots[<SLOT>]` instead
     * TODO
     */
    getSlotMaster(slot: number): import("@redis/client/dist/lib/cluster/cluster-slots").MasterNode<M, F, S, RESP, TYPE_MAPPING>;
}
export {};
