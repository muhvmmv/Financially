...
import { RedisModules, RedisFunctions, RedisScripts, RespVersions, Command, CommandArguments, ReplyUnion } from '@redis/client/dist/lib/RESP/types';
...
export declare class RedisLegacyClient {
    ...
    static getTransformReply(command: Command, resp: RespVersions): import("@redis/client/dist/lib/RESP/types").TransformReply | undefined;
