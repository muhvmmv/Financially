...
/// <reference types="node" />
/// <reference types="node" />
import { RedisArgument, RedisFunctions, RedisModules, RedisScripts, RespVersions, TypeMapping } from '@redis/client/dist/lib/RESP/types';
import { RedisClientType, RedisClientOptions, RedisClientExtensions } from '@redis/client/dist/lib/client';
...
export declare class RedisClientPool<M extends RedisModules = {}, F extends RedisFunctions = {}, S extends RedisScripts = {}, RESP extends RespVersions = 2, TYPE_MAPPING extends TypeMapping = {}> extends EventEmitter {
    ...
    sendCommand(args: Array<RedisArgument>, options?: CommandOptions): Promise<import("@redis/client/dist/lib/RESP/types").ReplyUnion>;
